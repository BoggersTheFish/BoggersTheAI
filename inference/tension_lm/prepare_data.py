...
def get_args():
    ...
    p.add_argument(
        "--out_dir", required=True, help="Output directory for shards and metadata"
    )
    p.add_argument(
        "--tokenizer",
        default=None,
...
def main():
    ...
    if args.tokenizer:
        ...
        print(
            f"Tokenizer loaded from {args.tokenizer}  "
    ...
    print(
        f"  shard size: {args.shard_size/1e6:.0f}M tokens  "
    ...
    print(
        f"  torchrun --nproc_per_node=2 train.py "
