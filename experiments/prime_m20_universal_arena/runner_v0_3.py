"""Globally alpha-spent v0.3 arena runner for PRIME M20."""
...
def run_world(
    *,
    ...
    if (
        ...
        if (
            initial_field.epoch != 0
            or initial_field.alpha_denominator
            != 128
            or initial_field.threshold
            != (
                128
            ...
            raise RuntimeError(
                "v0.3 global alpha schedule invariant failed"
            )
